...
public class MainActivity extends Activity 
{
   ...
   private TextView AmountPerPerson15TextView; //show amount with 15% tip per person
   private TextView AmountPerPersonCustomTextView;//show custom amount per person
   private int numOfPeople = 0; //show number of people
